...
from gnn_setup.utils import robust_training_utils as utils
...
class GreedyRBCD(PRBCD):
    ...
    def __init__(self, epochs: int = 500, **kwargs):
        ...
        # The parent SparseAttack class already handles the conversion and stores edge info
        # self.edge_index and self.edge_weight are already set by the parent class
        # Just ensure they are on the correct device and have the right dtype
