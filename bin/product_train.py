...
from gnn_setup.setups.data import make_products_dataset_splits, load_products_dataset_splits
...
def run(dataset_name, model_name, n_runs, model_configs, inductive,
    ...
    for i in tqdm(range(creating_splits)):
        ...
        make_products_dataset_splits(dataset_name, splits_root)
    ...
    for split in tqdm(dataset_splits):
        ...
        dataset = load_products_dataset_splits(
